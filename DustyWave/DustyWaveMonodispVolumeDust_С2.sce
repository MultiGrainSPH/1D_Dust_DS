...
rho_d=0.1;//плотность пыли//dust density
t_stop=10000;//время релаксации//relaxation time
...
theta=0.2;//объёмная доля//volume fraction

delta_rho_g_wave=0.01;

С_Const=1;//длина отрезка координат//coordinate length
t_Selected=0.2;//в какой момент времени рассматриваем волну//at what point in time we consider the wave
...
delta_u_d_wave = -%i*omega/(k*rho_d)*delta_rho_d_wave;
